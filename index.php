	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Edu-learn</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="https://sahil-salim-shaikh.github.io/Portfolio/">Carrier</a></li>
					<li> <a href="logout.php" id="our-location" class="btn-success" ><?php echo "Logout"   ?></a></li>
				</ul>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://www.instagram.com/mr_sahil__015/" class="fa fa-instagram"></a>
								<a href="" class="fa fa-reddit"></a>
								<a href="https://www.linkedin.com/in/sahil-salim-shaikh/" class="fa fa-linkedin"></a>
 ...
 -->
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container text-center" id="our-members">
				<h2><b>India's top educators to learn from</b></h2>
				<p>
					These are our excellent team you can contact anyone anytime <br> and all are experts and well experience
				</p>
			</div>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/sahil.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Sahil Shaikh</h4>
							...
							<div class="team-member text-center">
								<img src="img/newed.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Harry</h4>
							...
							<div class="team-member text-center">
								<img src="img/ed2.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Telusko</h4>
							...
							<div class="team-member text-center">
								<img src="img/ed3.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Adam</h4>
									<h4 class="team-member-designation">Sr. Fullstack Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/ed4.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Mosh</h4>
									<h4 class="team-member-designation">Python Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Edu-Learn is an online E-learning website <br>
